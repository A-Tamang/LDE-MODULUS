...
# Created: Winter 2014
#
# Future updates : Particular Solution Add-on
#                : Will be able to accept negative Modulo
#                : Make modulo more efficient by simplying before
#                  evaluating via EEA Algorithm
#                : MAIN UPDATE: Make into webpage 
#
# Purpose:   This program can evaluate any LDE (Linear Diophantine Equations
#                and Modulus Equations. It is fast and easy to use. To use,
#                simply run the program (f5) and follow the instructions.
#
#-------------------------------------------------------------------------------------------
import math
